...
export function createEnvironment() {
  ...
  function initializeTerritorialGeometry() {
    ...
    (REQUIRED_UI_IDS = Object.freeze([
      ...
      'createMenuBtn', 'mobileCreateBtn', 'objectSearchBtn', 'mapDisplayBtn', 'mobileSearchBtn', 'mobileDisplayBtn', 'resetViewBtn', 'terrainVisible', 'terrainPoliticalRadio', 'terrainPhysicalRadio', 'selectionToolbar', 'selectionToolbarNotesBtn', 'selectionToolbarEditBtn', 'selectionToolbarNotesPopover', 'flagMenuBtn', 'flagMenu', 'flagPreview', 'countryNameInput', 'countryColorInput', 'notesInput',
