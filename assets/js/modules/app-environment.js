...
export function createEnvironment() {
  ...
  function initializeTerritorialGeometry() {
    ...
    (REQUIRED_UI_IDS = Object.freeze([
      ...
      'editorScrollBody', 'editorObjectHeader', 'editorObjectStatus', 'emptyProperties', 'propertyTitle', 'propertyTypeLabel', 'editorTabBtn', 'actionsTabBtn', 'relationTabBtn', 'objectVisibilityBtn', 'objectVisibilityIcon', 'objectLockBtn', 'objectDeleteBtn', 'editorDeleteSection', 'editorTerritorialFlagSection', 'objectActionsMenu',
