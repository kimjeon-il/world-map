...
export function createEnvironment() {
  ...
  function initializeTerritorialGeometry() {
    ...
    (REQUIRED_UI_IDS = Object.freeze([
      ...
      'createMenuBtn', 'mobileCreateBtn', 'mobileMenuBtn', 'mobileGlobalMenu', 'mobileMenuFileBtn', 'mobileFileBackBtn', 'mobilePreferencesBtn', 'mobileHelpBtn', 'mobileUndoBtn', 'mobileRedoBtn', 'objectSearchBtn', 'mapDisplayBtn', 'mobileSearchBtn', 'mobileDisplayBtn', 'resetViewBtn', 'terrainNoneRadio', 'terrainPoliticalRadio', 'terrainPhysicalRadio', 'selectionToolbar', 'selectionToolbarNotesBtn', 'selectionToolbarTypeBtn', 'selectionToolbarEditBtn', 'selectionToolbarNotesPopover', 'flagMenuBtn', 'flagMenu', 'flagPreview', 'countryNameInput', 'countryColorInput', 'notesInput',
      ...
      'mapTopContextSlot', 'modeEditingContext', 'modeEditingHud', 'modeTaskWindowContent', 'modeTaskMinimizeBtn', 'modeActionBar', 'modeTaskName', 'modeTaskStage', 'modeTaskStatus', 'modeCancelIcon', 'modePrimaryIcon', 'modeTaskInstruction', 'modeTaskTargets', 'modeTaskTargetsLabel', 'modeTaskTargetList', 'modeTaskTargetsFocusBtn', 'modeTaskDisabledReason', 'annexCountryFlow', 'annexTargetCountryFlag', 'annexTargetCountryName', 'annexDonorCountryFlag', 'annexDonorCountryName',
      ...
      'multiCountryActions', 'multiBorderEditBtn', 'multiBorderEditHelp',
  ...
  return Object.freeze({
    ...
    get polygonClipping() { return globalThis.polygonClipping; },
