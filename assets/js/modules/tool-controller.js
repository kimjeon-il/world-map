export const TOOL_DEFINITIONS = Object.freeze({
  ...
  'merge-country-region': Object.freeze({ label: '권역 합치기', task: '권역 합치기', stage: '인접 권역 선택', cursor: 'country', special: true }),
  'split-country-region': Object.freeze({ label: '권역 나누기', task: '권역 나누기', stage: '경계 그리기', cursor: 'drawing', special: true, draft: Object.freeze({ shape: 'line', profile: 'boundary' }) }),
  ...
  'draw-country-region': Object.freeze({ label: '영역 직접 지정', task: '권역 추가', stage: '영역 그리기', cursor: 'drawing', special: true, draft: Object.freeze({ shape: 'polygon', profile: 'area' }) }),
