export const TOOL_DEFINITIONS = Object.freeze({
  ...
  'new-country': Object.freeze({ label: '국가 추가', task: '국가 추가', cursor: 'phased', special: true }),
  'annex-territory': Object.freeze({ label: '영토 편입', task: '영토 편입', cursor: 'phased', special: true }),
  ...
  lake: Object.freeze({ label: '호수 추가', task: '호수 추가', stage: '영역 그리기', cursor: 'drawing', special: true }),
  polygon: Object.freeze({ label: '영역 그리기', task: '영역 그리기', stage: '경계 그리기', cursor: 'drawing' }),
  line: Object.freeze({ label: '선 그리기', task: '선 그리기', stage: '경로 그리기', cursor: 'drawing' }),
