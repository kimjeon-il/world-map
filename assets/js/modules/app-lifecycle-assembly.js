      ...
      compose: [
        () => {
          projectUi = (0, dependencies.createProjectUiBridge)({
            ...
            isProjectReplacing: () => dependencies.projectDomain?.isReplacing?.() === true,
          ...
          propertyEditorUi = (0, dependencies.createPropertyEditorBindings)({
            ...
            enterTerritorialUnitCoastMode: dependencies.enterTerritorialUnitCoastMode,
            enterTerritorialCreateWorkflow: dependencies.enterTerritorialCreateWorkflow,
            enterTerritorialUnitAnnexMode: dependencies.enterTerritorialUnitAnnexMode,
