...
class V0150TypographyCopyTests(unittest.TestCase):
    def test_versioned_shell_and_cache_keys_match(self):
        ...
        self.assertIn("const ASSET_REVISION = '0.30.0-r26'", BOOTSTRAP)
        self.assertIn("app.css?v=0.30.0-r26", INDEX)
        self.assertIn("bootstrap.js?v=0.30.0-r26", INDEX)
        ...
        self.assertEqual(revisions, {"0.30.0-r26"})
