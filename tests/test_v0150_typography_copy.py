...
class V0150TypographyCopyTests(unittest.TestCase):
    def test_versioned_shell_and_cache_keys_match(self):
        self.assertIn('data-app-version="0.17.0"', INDEX)
        self.assertIn("const APP_VERSION = '0.17.0'", APP)
        self.assertIn("const BUILD_ID = '0.17.0'", BOOTSTRAP)
        self.assertIn("const ASSET_REVISION = '0.17.0'", BOOTSTRAP)
        self.assertIn("app.css?v=0.17.0", INDEX)
        self.assertIn("bootstrap.js?v=0.17.0", INDEX)
