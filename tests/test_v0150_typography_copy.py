...
class V0150TypographyCopyTests(unittest.TestCase):
    def test_versioned_shell_and_cache_keys_match(self):
        ...
        self.assertIn("const BUILD_ID = '0.23.0'", BOOTSTRAP)
        self.assertIn("const ASSET_REVISION = '0.23.0'", BOOTSTRAP)
        self.assertIn("app.css?v=0.23.0", INDEX)
        self.assertIn("bootstrap.js?v=0.23.0", INDEX)
